...
(async () => {
  ...
  // Fire-and-forget: ensure the Rain / Coffee preset MP3s are uploaded to
  // durable object storage with public ACL so the quick-pick buttons keep
  // working across container rebuilds (where attached_assets/ may be wiped).
